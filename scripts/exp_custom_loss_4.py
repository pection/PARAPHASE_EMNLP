...
def run_exp(args):
    ...
    seed_map = {
        'esnli': [7004, 3639, 6290, 9428, 7056, 4864, 4273, 7632, 2689, 8219, 4523, 2175, 7356, 8975, 51, 4199, 4182, 1331, 2796, 6341, 7009, 1111, 1967, 1319, 741, 7740, 1335, 9991, 6924, 6595, 5358, 2638, 6227, 8384, 2769, 9933, 6339, 3112, 1349, 8483, 2348, 834, 6895, 4823, 2913, 9962, 178, 2147, 8160, 1936, 4512, 2051, 4779, 2498, 176, 9599, 1181, 5320, 588, 4791],
        'cos_e': [4779, 2498, 176, 9599, 1181, 5320, 588, 4791],
        'ecqa': [4779, 2498, 176, 9599, 1181, 5320, 588, 4791],
        'sbic': [1234],
        'sensemaking': [7740, 1335, 9991, 6924, 6595, 5358, 2638, 6227, 8384, 2769, 9933, 6339, 3112, 1349, 8483, 2348, 834, 6895, 4823, 2913, 9962, 178, 2147, 8160, 1936, 4512, 2051, 4779, 2498, 176, 9599, 1181, 5320, 588, 4791]
    }
    ...
    for hparams in itertools.product(dataset_vals,
        ...
        for seed in seed_map.get(dataset, []):
            for format, n_shots in itertools.product(format_vals, n_shot_vals):
                ...
                if args.deepspeed:
                    cmd_prefix = "deepspeed scripts/input_to_label_and_rationale_custom_loss_4.py "
                    ...
                    cmd_prefix = "CUDA_VISIBLE_DEVICES=0 accelerate launch --debug scripts/input_to_label_and_rationale_custom_loss_4.py "
